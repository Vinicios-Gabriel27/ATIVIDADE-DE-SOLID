...
/**
 * Registro de uma pontuação. Só carrega dados; não lê arquivo nem decide regra de jogo.
 */
public class RankingEntry {
    ...
    public RankingEntry(String name, int score, Dificuldade dificuldade, int passageirosColetados,
                        String dataHora, long tempoJogo) {
        this.name = name;
        this.score = score;
